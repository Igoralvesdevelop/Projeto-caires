...
async function CreateUsuario(nome, cpf, data_nascimento, id_genero, nivel_acesso, id_condominio) {
    ...
    const sql =
        "INSERT INTO usuarios(nome, email, cpf, data_nascimento, id_genero, nivel_acesso, id_condominio) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    const infoUser = [nome, email, cpf, data_nascimento, id_genero, nivel_acesso, id_condominio];
